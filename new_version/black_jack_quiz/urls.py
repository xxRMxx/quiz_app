...
app_name = 'black_jack_quiz'

urlpatterns = [
    # BlackJack Quiz Join Flow
    path('join/', views.blackjack_join_view, name='join'),
    path('check-room/<str:room_code>/', views.check_room_code, name='check_room'),
    
    # Quiz Play Flow
    path('play/<str:room_code>/<str:participant_name>/', views.blackjack_play, name='play'),
    path('result/<str:room_code>/<str:participant_name>/', views.blackjack_result, name='result'),
