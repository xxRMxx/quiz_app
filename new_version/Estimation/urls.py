...
urlpatterns = [
    # Estimation Quiz Join Flow
    path('join/', views.estimation_join_view, name='join'),
    path('check-room/<str:room_code>/', views.check_room_code, name='check_room'),
    
    # Quiz Play Flow
    path('play/<str:room_code>/<str:participant_name>/', views.estimation_play, name='play'),
    path('result/<str:room_code>/<str:participant_name>/', views.estimation_result, name='result'),
