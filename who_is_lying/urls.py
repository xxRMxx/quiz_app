...
app_name = 'who_is_lying'

urlpatterns = [
    # Who is Lying Quiz Join Flow
    path('join/', views.who_join_view, name='join'),
    path('check-room/<str:room_code>/', views.check_room_code, name='check_room'),
    
    # Quiz Play Flow
    path('play/<str:room_code>/<str:participant_name>/', views.who_play, name='play'),
    path('result/<str:room_code>/<str:participant_name>/', views.who_result, name='result'),
